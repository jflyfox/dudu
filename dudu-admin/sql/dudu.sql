...
CREATE TABLE `sys_config` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10001 DEFAULT CHARSET=utf8 COMMENT='系统配置表';
...
CREATE TABLE `sys_department` (
  ...
  `create_id` bigint(20) DEFAULT '0' COMMENT '创建者',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10008 DEFAULT CHARSET=utf8 COMMENT='部门';
...
) ENGINE=InnoDB AUTO_INCREMENT=10006 DEFAULT CHARSET=utf8 COMMENT='数据字典主表';
...
CREATE TABLE `sys_dict_detail` (
  ...
  `create_id` bigint(20) DEFAULT '0' COMMENT '创建者',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10109 DEFAULT CHARSET=utf8 COMMENT='数据字典';
...
CREATE TABLE `sys_log` (
  ...
  `create_id` bigint(20) DEFAULT '0' COMMENT '创建者',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10001 DEFAULT CHARSET=utf8 COMMENT='日志';
...
CREATE TABLE `sys_menu` (
  ...
  `create_id` bigint(20) DEFAULT '0' COMMENT '创建者',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10001 DEFAULT CHARSET=utf8 COMMENT='菜单';

-- ----------------------------
-- Records of sys_menu
-- ----------------------------
INSERT INTO `sys_menu` VALUES ('1', '0', '首页', 'home', 'admin/home', '1', '1', '10', '1', '1', '2015-04-27 17:28:06', '1', '2015-04-27 17:28:06', '1');
INSERT INTO `sys_menu` VALUES ('2', '0', '系统管理', 'system_root', null, '1', '1', '190', '1', '1', '2015-04-27 17:28:06', '1', '2015-04-27 17:28:06', '1');
...
CREATE TABLE `sys_role` (
  ...
  `create_id` bigint(20) DEFAULT '0' COMMENT '创建者',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10001 DEFAULT CHARSET=utf8 COMMENT='角色';
...
CREATE TABLE `sys_user` (
  ...
  `create_id` bigint(20) DEFAULT '0' COMMENT '创建者',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10001 DEFAULT CHARSET=utf8 COMMENT='用户';
...
CREATE TABLE `sys_user_role` (
  ...
  `roleid` int(11) NOT NULL COMMENT '角色id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10001 DEFAULT CHARSET=utf8 COMMENT='用户和角色关联';
...
CREATE TABLE `tb_contact` (
  ...
  `create_id` bigint(20) DEFAULT '0' COMMENT '创建者',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10004 DEFAULT CHARSET=utf8 COMMENT='联系人';
